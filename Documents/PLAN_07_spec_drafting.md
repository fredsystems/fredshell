...
> a fixed exit status of `1`). See §14 row 08.2c. Remaining batch-1
> sheets (`echo`, `printf`, `:`, `set`, `shopt`, `unset`, `trap`)
> follow one per step. Then 08.3 / 08.6, sheet-driven `help` (08.7),
> refusal corpus cases (08.8), and the `pc` / `check` wiring of
> `check-specs`.
>
