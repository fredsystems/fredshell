...
> Last updated: 2026-06-28 — batch-1 drafting started (08.2): the
...
> See §14 row 08.2a. Remaining batch-1 sheets (`echo`, `printf`,
> `true`, `false`, `:`, `set`, `shopt`, `unset`, `trap`) follow one
> per step. Then 08.3 / 08.6, sheet-driven `help` (08.7), refusal
> corpus cases (08.8), and the `pc` / `check` wiring of `check-specs`.
>
