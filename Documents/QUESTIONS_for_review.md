...
> PLAN_13, PLAN_07, PLAN_08, PLAN_12, and the PLAN_06 Phase B
...
- **Q-08-C** (2026-05-23) — Accepted default + readability
  refinements. PLAN_07 §3 template permits optional
...
- **Q-08-D** (2026-05-23) — Accepted default. `refuse!` validates
  ...
  PLAN_07 §8.2 documents the rebuild-coupling cost as an
  accepted trade-off; PLAN_07 §11 Q08.4 added for audit trail.
- **Q-09-1** (2026-05-23) — Accepted default + refinement.
  PLAN_08 §2.3 pins `umask 022` for both fredshell and
  reference bash before each fuzz invocation. PLAN_08 §4.5
  (new) adds an excluded-builtins table covering `umask`,
  `exit`, `exec`, `cd`, `ulimit`, `trap`, and `kill`; their
  behaviours are owned by the PLAN_07 spec corpus rather than
  the fuzzer. PLAN_08 §11 Q09.1 marked resolved.
- **Q-09-2** (2026-05-23) — Accepted default. v1 oracle is
  bash-only; PLAN_08 §5.1 reference-shell trait already shaped
  to support `dash` / `mksh` as post-v1 extensions. PLAN_08
...
- **Q-09-3** (2026-05-23) — Accepted default. Functions remain
  ...
  pending parser-strategy ADR 0005 (per PLAN_11 §9 Q06B.1).
  Alias behaviour stays owned by the PLAN_07 spec corpus.
  PLAN_08 §11 Q09.3 marked resolved.
...
- **Q-09-5** (2026-05-23) — Accepted option (a): v1
  ...
  PLAN_08 §11 Q09.5, PLAN_07 §2.2 / §2.3, and `plan.md` row
  15 updated.
- **Q-06B-1** (2026-05-23) — Accepted default. In-house
  recursive-descent parser. ADR 0005 (subtask 06b.1)
  ratifies. PLAN_11 §3 prose updated and §9 Q06B.1
  marked resolved; PLAN_13 partial-line tolerance, lossless
  CST for the future formatter, and alias / parse-stage
  gating (PLAN_08 Q09.3) all cited as drivers.
- **Q-06B-3** (2026-05-23) — Accepted default. Here-doc
  ...
  `HEREDOC_PIPE_MAX` (not runtime-configurable). PLAN_07
  ...
  is documented and expected. PLAN_11 §9 Q06B.3 marked
  resolved.
- **Q-06B-4** (2026-05-23) — Accepted default. `$RANDOM`
  and `$SECONDS` pinned per case via PLAN_07 sheet `[harness]`
  ...
  absent. PLAN_11 §9 Q06B.4 marked resolved.
...
suggestion: ... }`. Refusal preserves the loud-failure
  ...
  PLAN_11 §9 Q06B.5 marked resolved.
