...
//! and the binary REPL both consume. See `PLAN_11` §2.4.
//!
//! All envelopes are `#[non_exhaustive]` so `PLAN_11` can add fields
...
///
/// `PLAN_11` removes the policy field once native execve lands;
